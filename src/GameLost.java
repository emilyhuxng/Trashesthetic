...
class GameLost extends JFrame {
	...
	GameLost() {
		...
		// Resize menu
		ImageIcon sb = new ImageIcon(getClass().getResource("Game Over Screen.png"));
		// ImageIcon newMap = sb.getScaledInstance(1200, 1200, Image.SCALE_DEFAULT);

		JButton startButton = new JButton(sb);
		startButton.setBackground(new Color(0, 0, 0, 0));
		startButton.setRolloverIcon(new ImageIcon(getClass().getResource("Game Over Screen.png")));
